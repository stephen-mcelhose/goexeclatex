...
| ----- | ----- | -------- |
| [#1](https://github.com/stephen-mcelhose/goexeclatex/issues/1) | Pre-pass byte offset drift corrupts downstream error positions | High — bug |
| [#2](https://github.com/stephen-mcelhose/goexeclatex/issues/2) | Spec gaps identified in GAN review (§6.1.3, whitespace, group context) | Medium |
